...
--
-- Name: phone_numbers; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER SEQUENCE phone_number_id_seq OWNED BY phone_numbers.id;
...
ALTER TABLE ONLY phone_numbers ALTER COLUMN id SET DEFAULT nextval('phone_number_id_seq'::regclass);
...
COPY accounts (id, auth_id, username) FROM stdin;
1	20S0KPNOIM	azr1
2	54P2EOKQ47	azr2
3	9LLV6I4ZWI	azr3
4	YHWE3HDLPQ	azr4
...
COPY phone_numbers (id, number, account_id) FROM stdin;
1	4924195509198	1
2	4924195509196	1
3	4924195509197	1
4	4924195509195	1
...
ALTER TABLE ONLY phone_numbers
    ADD CONSTRAINT phone_number_account_id_fkey FOREIGN KEY (account_id) REFERENCES accounts(id);
